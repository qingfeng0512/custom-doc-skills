---
name: langchain
description: LangChain v1.x framework for building LLM applications. Use for agents, chains, document retrieval, memory, tools, and integration with various LLM providers.
---
