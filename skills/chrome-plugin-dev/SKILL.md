...
description: 当需要开发Chrome扩展程序时使用此技能。包含Chrome Extension Development文档，涵盖manifest.json、权限声明、内容脚本、后台脚本、弹出窗口、选项页面、调试工具和发布流程等关键概念。
---

# Chrome-Plugin-Dev Skill

Comprehensive assistance with chrome-plugin-dev development, generated from official documentation.

## When to Use This Skill

This skill should be triggered when:
- Working with chrome-plugin-dev
- Asking about chrome-plugin-dev features or APIs
- Implementing chrome-plugin-dev solutions
- Debugging chrome-plugin-dev code
- Learning chrome-plugin-dev best practices
...
- **popup.md** - Popup documentation
- **publish.md** - Publish documentation
